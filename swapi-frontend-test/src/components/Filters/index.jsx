    ...
    <StyledContainer>
      <div className="ft">
        <form className="ft-form" onSubmit={handleSubmit}>
          <div className="ft-form__box">
            <label className="ft-form__label">Gender</label>
            <select
          ...
          <div className="ft-form__box">
            <label className="ft-form__label">Species</label>
            <select
              className="ft-form__select"
              name="species"
              onChange={handleChange}
          ...
          <div className="ft-form__box">
            <label className="ft-form__label">Films</label>
            <select
              className="ft-form__select"
              name="films"
              onChange={handleChange}
